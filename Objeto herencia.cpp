...
void Punto3::desplazarx(int a){
	estableceX((obtieneX()+a));
}

void Punto3::desplazary(int a){
	estableceY((obtieneY()+a));
}
...
public:
   ...
   double obtieneArea() const;           // devuelve el área
	double obtieneperimetrosemi();
	
	void incrementarradio(double);
...
void Circulo4::incrementarradio(double a){
	
	estableceRadio(obtieneRadio()*(1+(a/100)));
}

double Circulo4::obtieneperimetrosemi(){
	return 3.14159*obtieneRadio()+obtieneDiametro();
}
...
{  Circulo4 *circulo; // crea puntero a Circulo4
   ...
   cout << "\nEl area es " << circulo->obtieneArea();
 	...
 	circulo->desplazarx(2);
 	circulo->desplazary(2);
 	circulo->incrementarradio(50);
 	cout<<endl<<"Y: "<<circulo->obtieneY()<<endl<<"X: "<<circulo->obtieneX()<<endl<<"Radio: "<<circulo->obtieneRadio()<<endl<<"Perimetrosemi: "<<circulo->obtieneperimetrosemi();
