...
{  
   ...
   s.sethorasalida(16,0,0,0);
    s.sethoraingreso(8,0,0,1);
   s.sethorasalida(16,0,0,1);
    s.sethoraingreso(8,0,0,2);
   s.sethorasalida(16,0,0,2);
    s.sethoraingreso(8,0,0,3);
   s.sethorasalida(16,0,0,3);
    s.sethoraingreso(8,0,0,4);
   s.sethorasalida(16,0,0,4);
   s.getlaburo();
